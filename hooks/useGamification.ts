...
const LEVEL_THRESHOLDS: LevelThreshold[] = [
  ...
  { level: 6, pointsRequired: 1500, rankTitle: 'IAMROOT Hunter' },
  { level: 7, pointsRequired: 2100, rankTitle: 'IAMROOT Hunter' },
  { level: 8, pointsRequired: 2800, rankTitle: 'IAMROOT Hunter' },
  { level: 9, pointsRequired: 3600, rankTitle: 'IAMROOT Hunter' },
  { level: 10, pointsRequired: 4500, rankTitle: 'IAMROOT Hunter' },
  { level: 11, pointsRequired: 5500, rankTitle: 'IAMROOT Hunter' },
  { level: 12, pointsRequired: 6600, rankTitle: 'IAMROOT Hunter' },
  { level: 13, pointsRequired: 7800, rankTitle: 'IAMROOT Hunter' },
  { level: 14, pointsRequired: 9100, rankTitle: 'IAMROOT Hunter' },
  { level: 15, pointsRequired: 10500, rankTitle: 'IAMROOT Hunter' },
  { level: 16, pointsRequired: 12000, rankTitle: 'IAMROOT Hunter' },
  { level: 17, pointsRequired: 13600, rankTitle: 'IAMROOT Hunter' },
  { level: 18, pointsRequired: 15300, rankTitle: 'IAMROOT Hunter' },
  { level: 19, pointsRequired: 17100, rankTitle: 'IAMROOT Hunter' },
  { level: 20, pointsRequired: 19000, rankTitle: 'IAMROOT Hunter' },
  { level: 21, pointsRequired: 21000, rankTitle: 'IAMROOT Legend' },
  { level: 22, pointsRequired: 23500, rankTitle: 'IAMROOT Legend' },
  { level: 23, pointsRequired: 26500, rankTitle: 'IAMROOT Legend' },
  { level: 24, pointsRequired: 30000, rankTitle: 'IAMROOT Legend' },
  { level: 25, pointsRequired: 34000, rankTitle: 'IAMROOT Legend' },
  { level: 30, pointsRequired: 50000, rankTitle: 'IAMROOT Legend' },
  { level: 40, pointsRequired: 100000, rankTitle: 'IAMROOT Legend' },
  { level: 50, pointsRequired: 200000, rankTitle: 'IAMROOT Legend' },
];
