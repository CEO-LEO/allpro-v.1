...
const articles = [
  ...
  {
    id: 2,
    title: 'CP ALL เปิดตัวโปรโมชั่นใหม่! ช้อปครบ 300 รับคูปอง 50 บาท',
    excerpt: 'เครือ CP ALL ประกาศแคมเปญใหม่สำหรับสมาชิก ALL member โดยมีโปรโมชั่นพิเศษตลอดเดือนกุมภาพันธ์...',
    image: '🎁',
